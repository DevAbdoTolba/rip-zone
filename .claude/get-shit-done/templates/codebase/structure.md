...
- Usage: Reference from command with `@/home/appuser/workspace/rip-zone/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /home/appuser/workspace/rip-zone/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/appuser/workspace/rip-zone/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

...
- **Global scope**: `/home/appuser/workspace/rip-zone/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/appuser/workspace/rip-zone/.claude/notes/`)
...
2. Glob `/home/appuser/workspace/rip-zone/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/appuser/workspace/rip-zone/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/appuser/workspace/rip-zone/.claude/notes/` — works in any directory

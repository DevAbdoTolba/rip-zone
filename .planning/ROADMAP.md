...
**Plans:** 6 plans
Plans:
- [ ] 04-01-PLAN.md — Foundation: Dexie v2 schema, extended Zustand store, PR detection, 4-tab nav, route stubs
- [ ] 04-02-PLAN.md — Seed data: PPL, Arnold Split, and Upper/Lower Superset Egyptian gym splits
- [ ] 04-03-PLAN.md — Workout logger UI: exercise picker sheet, set rows, rest timer widget, PR badges
- [ ] 04-04-PLAN.md — History page: contribution graph heatmap, git-log timeline, expandable session detail
- [ ] 04-05-PLAN.md — Plan runner: plan browser with recommendations, day picker, progress tracking
...
| 4. Workout Logger | 0/6 | Not started | - |

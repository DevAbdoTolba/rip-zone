...
**Plans:** 5 plans
Plans:
- [ ] 02-01-PLAN.md — Infrastructure: @svgr/webpack, SVG type declaration, useMapStore extension, CSS selectors, test scaffolds
- [ ] 02-02-PLAN.md — Normal mode SVG authoring (front + back) and path ID validation script
- [ ] 02-03-PLAN.md — Advanced + Anatomy mode SVG authoring (4 files) and validation update
- [ ] 02-04-PLAN.md — React components (MuscleMap, Canvas, Controls) and home page integration
...
| 2. Muscle Map SVG | 0/5 | Not started | - |
